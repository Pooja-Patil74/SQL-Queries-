...
SELECT b.author, SUM (o.quantity) AS Total_amount_sold
FROM Orders o
JOIN books b ON o.book_id = b.book_id
GROUP BY b.Author;
...
SELECT b.book_id, b.title,b.stock, COALESCE(SUM(quantity),0) AS order_quantity,b.stock- COALESCE(SUM(o.quantity),0) AS Remaining_Quantiy
FROM books b
